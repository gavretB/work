    ...
    def play
      ...
      if @bossmode ==5 then
        ...
        @player.draw
         ...
         Window.draw_font(0, 420," いいかげんに起きなさい\n あとクリアおめでとう", @fontpoint, :color =>[255, 255,0])

         if Input.key_push?(K_N)#1 == @board.digital_read(2) then
        ...
        Window.draw_font(50, 450," いいかげんに寝なさい", @fontpoint, :color =>[255, 255, 255])
          if Input.key_push?(K_N)#1 == @board.digital_read(2) then
            @bossmode=1
